namespace SFA.DAS.Funding.Provider.Web.Tests.Shared
{
    public class TestHelper
    {
        private readonly TestContext _testContext;

        public static JsonSerializerSettings DefaultSerialiserSettings = new() { ContractResolver = new CamelCasePropertyNamesContractResolver() };
                   ...
                   int timeoutInMs = 15000)
        {
            ...
            hook!.OnReceived = _ => { waitForResult.SetHasStarted(); };
            hook.OnProcessed = _ => { waitForResult.SetHasCompleted(); };
