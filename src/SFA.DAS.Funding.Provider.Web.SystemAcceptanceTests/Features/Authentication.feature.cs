...
namespace SFA.DAS.Funding.Provider.Web.SystemAcceptanceTests.Features
{
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Authentication", "\tIn order to prevent unauthoried access\r\n\tAs a system\r\n\tI want to only allow auth" +
        ...
        public virtual void AnUnauthorisedUserIsAskedToLogOn(string url, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("An unauthorised user is asked to log on", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
